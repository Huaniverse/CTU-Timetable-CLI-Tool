...
echo.
echo  %CYAN%╔════════════════════════════════════════════════════════════╗%RESET%
echo  %CYAN%║%BOLD%%WHITE%          HUANIVERSE TIMETABLE TOOL - CÀI ĐẶT TỰ ĐỘNG       %RESET%%CYAN%║%RESET%
echo  %CYAN%╚════════════════════════════════════════════════════════════╝%RESET%
echo.
...
echo    %CYAN% Đang tạo môi trường ảo 'venv' để giữ sạch máy tính...%RESET%
...
echo  %MAGENTA%[Bước 3/4]%RESET% Kiểm tra thư viện hỗ trợ...
...
echo    %CYAN% Đang cài đặt/cập nhật thư viện (pandas, playwright...)...%RESET%
...
echo.
echo  %CYAN%╔════════════════════════════════════════════════╗%RESET%
echo  %CYAN%║%BOLD%%GREEN%    TẤT CẢ ĐÃ SẴN SÀNG - ĐANG KHỞI ĐỘNG TOOL    %RESET%%CYAN%║%RESET%
echo  %CYAN%╚════════════════════════════════════════════════╝%RESET%
echo.
:: Chạy file main
python main.py
